...
med_flame_sprites = []
for i in range(6):
    med_flame_sprite = pygame.image.load("med_flame_{0}.png".format(i + 1))
...
small_flame_sprites = []
for i in range(4):
    small_flame_sprite = pygame.image.load("small_flame_{0}.png".format(i + 1))
...
smoke_sprites = []
for i in range(6):
    smoke_sprite = pygame.image.load("smoke_{0}.png".format(i + 1))
